...
export interface AudioSegment {
  ...
  type: 'narration' | 'click' | 'keypress' | 'keypress-return' | 'keypress-letter-1' | 'keypress-letter-2' | 'keypress-letter-3' | 'keypress-letter-4' | 'keypress-letter-5' | 'keypress-space-1' | 'keypress-space-2' | 'keypress-space-3' | 'keypress-space-4' | 'keypress-space-5';
}
